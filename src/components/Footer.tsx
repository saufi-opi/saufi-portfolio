import { getHomepageVisitors, getSettings } from '@/lib/data'

export default async function Footer() {
  const [s, visitors] = await Promise.all([getSettings(), getHomepageVisitors()])
      ...
      <div className="footer-meta">
        <div className="container">
          ...
          <span className="footer-note">
            ...
            <span
              className="footer-views"
              title={`${visitors} unique homepage visitors (one count per visitor per day)`}
            >
              {visitors} visitors
            </span>
          </span>
